 ...
 *
 * This is the test suite shipped with `@types/morgan` (originally created by
 * staticfunction on 8/3/14), kept here unchanged so that any regression against
 * the previously published typings shows up as a compile error.
 */
